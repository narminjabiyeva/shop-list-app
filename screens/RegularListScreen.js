...
export const RegularListScreen = connect(mapStateToProps, {deleteList})(({deleteList,sections,navigation}) => {
    ...
    const section = sections.find((section) => section.name === "regular list");
